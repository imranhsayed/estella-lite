...
if ( ! function_exists( 'estella_library_get_all_fonts' ) ) :
/**
 ...
 */
function estella_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'estella' ) ) ) );
	$standard_fonts = estella_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'estella' ) ) ) );
	$google_fonts   = estella_library_get_google_fonts();
	 ...
	 */
	return apply_filters( 'estella_library_all_fonts', array_merge( $heading1, $standard_fonts, $heading2, $google_fonts ) );
}
endif;

if ( ! function_exists( 'estella_library_get_font_choices' ) ) :
/**
 * Packages the font choices into value/label pairs for use with the customizer.
 *
 * @since  1.0.0.
 ...
 * @return array    The fonts in value/label pairs.
 */
function estella_library_get_font_choices() {
	$fonts   = estella_library_get_all_fonts();
	$choices = array();
...
if ( ! function_exists( 'estella_library_get_google_font_uri' ) ) :
/**
 ...
 */
function estella_library_get_google_font_uri( $key, $default , $variant_key, $subset_key ) {

	$font = trim(get_theme_mod( $key, $default ));

	// De-dupe the fonts
	$allowed_fonts = estella_library_get_google_fonts();
...
if( ! function_exists( 'estella_get_google_fonts_variants' ) ) :
 ...
 */
function estella_get_google_fonts_variants( $key , $default , $font_name = false )
{
	$font = $font_name ? $font_name : get_theme_mod( $key , $default );

	$fonts = estella_library_get_google_fonts();
...
if( ! function_exists( 'estella_get_google_fonts_subsets' ) ) :
 ...
 * @return [array] variant array
 */
function estella_get_google_fonts_subsets( $key , $default, $font_name = false )
{
	$font = $font_name ? $font_name : get_theme_mod( $key , $default );
...
if ( ! function_exists( 'estella_library_get_standard_fonts' ) ) :
/**
 ...
 */
function estella_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'estella' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'estella' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'estella' ),
...
if ( ! function_exists( 'estella_library_get_font_stack' ) ) :
/**
 ...
 */
function estella_library_get_font_stack( $font ) {

	$all_fonts = estella_library_get_all_fonts();

	// Sanitize font choice
	$font = estella_library_sanitize_font_choice( $font );
...
if ( ! function_exists( 'estella_library_sanitize_font_choice' ) ) :
/**
 ...
 */
function estella_library_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
		// The array key is an integer, so the chosen option is a heading, not a real choice
		return '';
	} else if ( array_key_exists( $value, estella_library_get_font_choices() ) ) {
		return $value;
	} else {
		return '';
	}
...
if ( ! function_exists( 'estella_library_get_google_fonts' ) ) :
/**
 ...
 */
function estella_library_get_google_fonts() {
	return apply_filters( 'estella_library_get_google_fonts', array(
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
				'regular',
